...
values
  (
    ...
    null,
    'medium',
    'Public educational preview of an index watchlist card focused on structure, risk framing, and review workflow. Full context is intentionally limited to non-advisory sample language.',
  ...
  (
    ...
    null,
    'medium',
    'Public educational preview of a market structure note focused on scenario planning and risk awareness. It does not include actionable levels or a trade instruction.',
  ...
  (
    ...
    'high',
    'Premium research preview describing the planned card format and risk-first workflow without revealing proprietary thesis details, exact levels, or targets.',
  ...
  (
    ...
    null,
    'medium',
    'Pro research preview describing the planned macro review format without revealing full scenario detail, proprietary notes, or actionable levels.',
